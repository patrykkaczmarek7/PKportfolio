                ...
                <div className={` ${ animated ? '' : 'translate-y-10 opacity-0'} transform transition duration-2000 pb-6`}>
                    ...
                    <div className="w-full lg:inline-flex lx:inline-flex">
                        <div className="text-center w-full"> <br/> <br className="md:hidden lg:hidden lx:hidden"/>
                            ...
                            <img className="inline-block text-gray-700 transform motion-reduce:transform-none hover:-translate-y-1 hover:scale-110 transition ease-in-out duration-300 text-center rounded-md bg-gray-100 px-4 py-2 m-2 h-16 md:h-32 lg:h-20 xl:h-24" src={angular}/> <br/>
